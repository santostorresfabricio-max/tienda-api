...
<body>
    ...
    <div class="container">
    <h2 class="table-title">Panel de Profesores</h2>

    <button class="btn-add">
        <i class="fa-solid fa-user-tie"></i> Registrar Profesor
    </button>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div style="font-weight: 500;">{{ $profesor->nombre }} {{ $profesor->apellidos }}</div>
                        <div style="font-size: 11px; color: var(--text-light);"></div>
                    </td>
                    <td>{{ $profesor->especialidad }}</td>
                    <td class="actions">
                        <button class="btn-action btn-edit"><i class="fa-solid fa-user-pen"></i></button>
                        <button class="btn-action btn-delete"><i class="fa-solid fa-user-minus"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
